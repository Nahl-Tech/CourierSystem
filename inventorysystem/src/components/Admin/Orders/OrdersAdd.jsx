  ...
  return (
    <>
      ...
      <div
        ...
        className="md:w-[68vw] lg:w-[80vw] mt-8 w-[100vw] overflow-scroll h-[100vh] mx-auto p-4 md:p-6 lg:p-6"
      >
          ...
          <div className="parent lg:flex lg:flex-wrap lg:justify-evenly">
            ...
            <div className="mb-4 lg:w-2/5">
              ...
              <div className="flex items-center border border-gray-300 rounded">
                <span className="bg-gray-200 text-gray-700 py-2 px-3 rounded-lg">
                  +92
                </span>
                <input
                  type="text"
                  ...
                  value={custNumber}
                  className="flex-grow mt-2 shadow appearance-none border-none rounded-r py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
              </div>
            </div>
