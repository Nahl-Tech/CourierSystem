...
const OrdersList = () => {
  ...
  return (
    <>
      ...
      >
        {/* Filters Div */}
        <div className="flex flex-wrap justify-evenly p-1 md:w-[80vw] w-full mt-5 md:mt-1 ">
          <input
            type="text"
            placeholder="Search by Tracking Code"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="border rounded p-2 w-full sm:w-[180px] ml-1"
          />
        ...
        <div className="flex flex-wrap justify-between pl-5 mt-2">
          <div className="flex justify-start items-start">
            ...
            <button
              onClick={clearFields}
              className="mt-2 ml-1 py-1 px-4 rounded-md transition duration-300 ease-in-out items-center bg-blue-500 text-white hover:bg-blue-600"
            >
              Clear
            </button>
          </div>
          ...
          <div className="mr-5">
            ...
            <span className="text-gray-700 ml-[3px] mr-[3px]">
            ...
            <table className="modal-table w-full mb-4 ">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2">{selectedOrder.cust_town}</td>
                </tr>
                <tr>
