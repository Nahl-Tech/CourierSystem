...
const createOrder = async (req, res) => {
  try {
    ...
    // Cust_number ko check karna agar wo 11 digits ka nahi hai aur 0 se start nahi hota
    if (req.body.cust_number && !req.body.cust_number.startsWith("0")) {
      req.body.cust_number = "0" + req.body.cust_number;
    }
    console.log(req.body.cust_number);
...
const updateOrder = async (req, res) => {
  try {
    ...
    io.emit("orderUpdated", {
      ...
      remaining_balance: updatedOrder.remaining_balance,
